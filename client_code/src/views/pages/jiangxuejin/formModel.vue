	...
	<div class="detail-page">
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth('jiangxuejin','申请')" @click="jiangxuejinshenqingonAcross('申请','','','','')" type="warning">申请</el-button>
					<el-button class="edit_btn" v-if="centerType&&btnAuth('jiangxuejin','修改')" type="primary" @click="editClick">修改</el-button>
					<el-button class="del_btn" v-if="centerType&&btnAuth('jiangxuejin','删除')" type="danger" @click="delClick">删除</el-button>
				</div>
			</div>
		</div>
	</div>
